...
local_rank = -1
tokenizer = None
#login(token="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") # Replace with your Hugging Face token
...
class ModelArguments:
    ...
    model_name_or_path: Optional[str] = field(default="/home/cv/Blaise/BaMCo/VQA/src/checkpoints/Llama-3.2-3B", metadata={"help": "Path to the LLM or MLLM."}) #"meta-llama/Llama-3.2-1B", "openai-community/gpt2-xl"
    ...
    knowledge_encoder_checkpoint: Optional[str] = field(default="/home/cv/Blaise/BaMCo/KSpace/src/checkpoints/Slake_KnowledgeSpace.pt")
...
@dataclass
class DataArguments:
    data_root: str = field(default="KSpace/Datasets", metadata={"help": "Root directory for all data."})
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    bf16: bool = True
    checkpoint_dir: str = "/home/cv/Blaise/BaMCo/VQA/src/checkpoints"
    ...
    output_dir="/home/cv/Blaise/BaMCo/VQA/src/outputs",
...
def main():
    ...
    #===================== mod end ===============================
        ...
        #state_dict = torch.load('/home/cv/Blaise/BaMCo/VQA/src/checkpoints/pytorch_model_best_curriculum.bin', map_location="cuda:0", weights_only=True)
