...
def build_vision_tower(config, **kwargs):
    ...
    if 'vit' in vision_tower.lower():
        ...
        model = KGEncoder(num_classes=config.num_classes)
...
def build_knowledge_encoder(config, **kwargs):
    ...
    if knowledge_encoder == True:
        ...
        model.tokenizer = open_clip.get_tokenizer('/home/cv/Blaise/BaMCo/VQA/src/checkpoints/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224')
